...
class GameStatsService():
    ...
    #################################################
    def get_defensive_stats_leaders(self):
        ...
        converted_long_int_ret: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in long_int_ret_data]
        converted_sacks: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in sacks_data]
        converted_ff: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in ff_data]
        converted_safeties: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in safeties_data]
        converted_pass_def: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in pass_def_data]
        converted_blocked_kicks: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in blocked_kicks_data]
        converted_tfl: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in tfl_data]
        converted_ints_made: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in ints_made_data]
        converted_fr: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in fr_data]
        converted_def_td: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in def_td_data]
        converted_fr_yards: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in fr_yards_data]
        converted_int_ret_yards: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in int_ret_yards_data]
        converted_total_tkls: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in total_tkls_data]
        converted_total_sacks: List[PlayerDefensiveStats] = [self._get_player_season_defensive_stats(player) for player in total_sacks_data]
    ...
    def get_passing_stats_leaders():
        ...
        pass_ypa_data = session.query(PlayerInfoData, GameOffensiveStatsData).filter(
                PlayerInfoData.id == GameOffensiveStatsData.player_id,
                GameOffensiveStatsData.pass_att > 10,
                ).order_by(desc(GameOffensiveStatsData.pass_ypa)).limit(10)
    ...
    def get_rec_stats_leaders():
        ...
        rec_ypc_data = session.query(PlayerInfoData, GameOffensiveStatsData).filter(
                PlayerInfoData.id == GameOffensiveStatsData.player_id,
    ...
    def get_rush_stats_leaders():
        ...
        rush_ypc_data = session.query(PlayerInfoData, GameOffensiveStatsData).filter(
                PlayerInfoData.id == GameOffensiveStatsData.player_id,
                GameOffensiveStatsData.rush_att > 10
                ).order_by(desc(GameOffensiveStatsData.rush_ypc)).limit(10)
    ...
    def _get_player_season_defensive_stats(self, player) -> PlayerDefensiveStats:
        ...
        player_details: PlayerDetails = self._get_player_details(player=player_info)
