...
class GameStatsService():
    ...
    def _get_player_season_defensive_stats(self, player) -> PlayerDefensiveStats:
        ...
        player_details: PlayerDetails = self._get_player_details(
            player=player_info)
        defensive_stats: SeasonDefensiveStatsData = _get_defensive_stats(
    ...
    def _get_player_details(self, player: PlayerInfoData) -> PlayerDetails:
        ...
        team_info: TeamInfoData = session.query(TeamInfoData).filter(
            TeamInfoData.id == player.team_id).one()
