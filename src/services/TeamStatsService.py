...
class TeamStatsService():
    ...
    def compile_game_stats(self, team_game_stats: TeamGameStatsData) -> TeamGameStats:
    ...
    def _compile_prior_team_game_stats(self, team_game_stats_data: List[TeamGameStatsData]):

        prior_team_game_stats: List[TeamGameStats] = [self.compile_game_stats(game) for game in team_game_stats_data]
    ...
    def compile_team_season_stats(team_stats_data: TeamSeasonStatsData):
