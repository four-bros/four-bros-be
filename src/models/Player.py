...
class PlayerDetails:
    def __init__(self, id, team_id, first_name, last_name, height, weight,
                 jersey_number, player_year, redshirt, position, hometown_desc
                 ):
            self.id = id
...
class PlayerAbilities:
    def __init__(self, play_recognition, press, power_moves, kick_accuracy, throwing_power, throwing_accuracy, overall,
                 agility, stamina, acceleration, pursuit, route_running, speed, trucking, ball_carrier_vision, catch_in_traffic,
                 block_shedding, strength, catch, injury, tackling, pass_blocking, run_blocking, break_tackle, impact_blocking,
                 jump, carry, stiff_arm, kick_power, awareness, release, spec_catch, elusiveness, spin_move, hit_power, 
                 kick_return, man_coverage, zone_coverage, finesse_moves, juke_move
                 ):
...
class Player:
    def __init__(self, player_details, player_abilities):
