...
class SeasonLeadersController():
    ...
    def get_player_season_stats_leaders(self, is_season_specific: bool, is_users_only: bool):
        response = {
            'defense': self.SeasonLeadersService.get_season_defensive_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
            'kick_return': self.SeasonLeadersService.get_season_kick_return_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
            'kicking': self.SeasonLeadersService.get_season_kicking_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
            'passing': self.SeasonLeadersService.get_season_passing_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
            'punt_return': self.SeasonLeadersService.get_season_punt_return_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
            'punting': self.SeasonLeadersService.get_season_punting_stats_leaders(
                is_season_specific=is_season_specific, is_users_only=is_users_only
            ),
